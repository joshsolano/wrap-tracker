...
import { B, CC, TYPE_OPTS, calcSqft } from '../../lib/utils'
            ...
            {installers.map(i => (
              <button
                ...
                style={{
                  padding: '8px 14px',
                  borderRadius: 20,
                  border: `1.5px solid ${installerId === i.id ? i.color : B.border}`,
                  background: installerId === i.id ? i.color + '18' : 'transparent',
                  color: installerId === i.id ? i.color : B.textSec,
                  fontWeight: installerId === i.id ? 700 : 400,
                  fontSize: 13,
                  cursor: 'pointer',
                }}
              >
            ...
            {TYPE_OPTS.map(t => (
              <button
                ...
                style={{
                  padding: '7px 13px',
                  borderRadius: 18,
                  border: `1.5px solid ${jobType === t ? B.yellow : B.border}`,
                  background: jobType === t ? B.yellow + '18' : 'transparent',
                  color: jobType === t ? B.yellow : B.textSec,
                  fontWeight: jobType === t ? 700 : 400,
                  fontSize: 13,
                  cursor: 'pointer',
                }}
              >
